import { EllipsisHorizontal, PencilSquare, Plus, Trash } from "@repo/icons";
...
function SortingDemo(): JSX.Element {
...
function SelectDemo(): JSX.Element {
  ...
  const onSelectCurrency = (currency: string): void => {
  ...
  const onSelectRegion = (region: string): void => {
...
function ComplexMenuDemo(): JSX.Element {
  return (
    <FocusModal>
